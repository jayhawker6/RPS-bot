...
def playoff(player1, player2, number_of_rounds=60):
  ...
  """
    ...
    for round_number in range(number_of_rounds):
        move1, move2, new_score1, new_score2 = round(player1, player2,
                                                     my_history1, my_history2)
  ...
  """
    ...
    for player1 in argv:
        ...
        for player2 in argv[argv.index(player1) + 1:]:
            ...
            score1, score2, history1, history2 = playoff(
                player1.move, player2.move, number_of_rounds)
            scores[player1_name].append(score1)
            scores[player2_name].append(score2)
            score1 = str(score1[0]) + "-" + str(score1[1]) + "-" + str(
                score1[2])
            score2 = str(score2[0]) + "-" + str(score2[1]) + "-" + str(
                score2[2])
